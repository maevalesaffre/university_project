...
## On souhaite que chaque couleur appraisse au moins deux fois:
phi4 = [[encode(ee,c) for ee in etats if ee != e] for c in couleurs for e in etats]

# Résolution du problème

## On instancie le solver
with Minisat22(bootstrap_with=phi1+phi2+phi3+phi4) as m:
