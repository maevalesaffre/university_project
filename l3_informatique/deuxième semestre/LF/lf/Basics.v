...
Theorem plus_id_exercise : forall n m o : nat,
  n = m -> m = o -> n + m = m + o.
Proof.
  (* We insert vars into context *)
  intros n m o.
  (* We insert the first hypotesis into the context  *)
  intro H1.
  (* We insert the second one in it  *)
  intro H2.
  (* We rewrite both hypothesis (can be done in chain or after any hypothesis introduction *)
  rewrite -> H1.
  rewrite -> H2.
  (* we finally use reflexivity *)
  reflexivity.
Qed.
(** [] *)
