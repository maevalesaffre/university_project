...
Proof.
  ...
  induction n.
    ...
    - simpl. intros m H. split. discriminate. discriminate H.
Qed.
...
Proof.
  unfold not.
  intros P. intro H1. intro Q. intro H2. destruct H1. apply H2.
Qed. 
...
intros P Q.
  split.
  - intro P1. apply H. left. apply P1.
  - intro Q1. apply H. right. apply Q1.
Qed.
...
Theorem iff_trans : forall P Q R : Prop,
  (P <-> Q) -> (Q <-> R) -> (P <-> R).
Proof.
  intros P Q R [H1A H1B] [H2A H2B].
  split.
    - intro P1. apply H2A. apply H1A. apply P1.
    - intro R1. apply H1B. apply H2B. apply R1.
Qed.
(** [] *)
...
split.
- intros [HA1 | [HA2 HA3]].
  split. left. apply HA1. left. apply HA1. split. right. apply HA2. right. apply HA3.
- intros [[HB1 | HB2] [HB3 | HB4]]. left. apply HB1. left. apply HB1. left. apply HB3. right. split. apply HB2. apply HB4.
Qed.
(** [] *)
...
Proof.
unfold not.
  intros X P H1 [x E]. apply E. apply H1.
Qed.
(** [] *)
...
Proof.
  intros X P Q.
  split.
    - intros [x E]. destruct E. left. exists x. apply H. right. exists x. apply H.
    - intros [[x1 E1] | [x2 E2]]. exists x1. left. apply E1. exists x2. right. apply E2.
Qed.
(** [] *)
...
Proof.
  intros n m E.
  induction n.
  - exists m. simpl. reflexivity. Admitted.

Theorem plus_exists_leb : forall n m, (exists x, m = n+x) -> n <=? m = true.
Proof.
  intros n m [x E]. rewrite E. Admitted.
(** [] *)
