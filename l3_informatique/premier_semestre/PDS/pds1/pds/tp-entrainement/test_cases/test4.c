...
char* expected_str[NB_EXPECTED] = {"test_cases/arbo_test4/a"};
...
int main(int argc, char* argv[]) {
    ...
    printf("Running exercice 1 on \"test_cases/arbo_test4/\"\n");

    pid_t p = fork();
    if(p == 0) {
        liste_sous_reps("test_cases/arbo_test4/");
        bool all_found = true;
        ...
        if(all_found && !failed) {
            ...
            ADD_POINT(testfile, "arbo_test4", 1);
        }
