...
#define NB_EXPECTED 4
char* expected_str[NB_EXPECTED] = {"test_cases/arbo_test6/rep", "test_cases/arbo_test6/link1", "test_cases/arbo_test6/link2", "test_cases/arbo_test6/link3"};
bool found[NB_EXPECTED] = {false, false, false, false};
bool failed = false;
...
int main(int argc, char* argv[]) {
    ...
    printf("Running exercice 1 on \"test_cases/arbo_test6/\"\n");

    pid_t p = fork();
    if(p == 0) {
        liste_sous_reps("test_cases/arbo_test6/");
        bool all_found = true;
        ...
        if(all_found && !failed) {
            ...
            ADD_POINT(testfile, "arbo_test6", 2);
        }
