...
char* expected_str[NB_EXPECTED] = {"test_cases/arbo_test2/sous_rep1", "test_cases/arbo_test2/a"};
...
int main(int argc, char* argv[]) {
    ...
    printf("Running exercice 1 on \"test_cases/arbo_test2/\"\n");

    pid_t p = fork();
    if(p == 0) {
        liste_sous_reps("test_cases/arbo_test2/");
        bool all_found = true;
        ...
        if(all_found && !failed) {
            ...
            ADD_POINT(testfile, "arbo_test2", 2);
        }
